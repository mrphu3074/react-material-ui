AppBar = React.createClass({
  ...
  _onLeftIconButtonClick: function(e) {
    if (this.props.onLeftIconButtonClick) this.props.onLeftIconButtonClick(e);
  },

  _onRightIconButtonClick: function(e) {
    if (this.props.onRightIconButtonClick) this.props.onRightIconButtonClick(e);
  }
